# Get Freight Analysis Framework (FAF) data
getFAF <- function (year) {
  ...
  # Convert wright-distance from thousand ton-miles to ton-miles
  FAF[, paste0("tmiles_", year)] <- FAF[, paste0("tmiles_", year)]*1E3
  return(FAF)
}
